...
public class ClassObj extends BasicObj {
  ...
  @Override
    ...
    int y1 = origin.y + (height / 5);
    int y2 = y1 + (height - height / 5) / 2;
    g2d.drawLine(origin.x, y1, origin.x + width, y1);
    g2d.drawLine(origin.x, y2, origin.x + width, y2);
  ...
  public void showObjName(Graphics2D g2d) {
    if (objName != null){
			...
			g2d.drawString(objName, origin.x + width/5, origin.y + height/7);
		}
  }
}
